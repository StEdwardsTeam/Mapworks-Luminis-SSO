...
class FacultyMAPWorksPortlet {

	def title = 'Faculty MAP-Works'
	def description = '''
This portlet enables single sign-on capability to MAP-Works
'''
	def displayName = 'Faculty MAP-Works'
    ...
    def liferay_portlet_configuration_action_class = 'edu.stedwards.luminis.portlets.sso.FacultyMAPWorks.ConfigurationActionImpl'
	...
	def actionView = {
        ...
        def loginURL = facultyMAPWorksService.getLoginURL(PPrsn.getPersonId(), institutionId)
